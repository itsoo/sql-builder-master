...
import com.github.jonathanhds.sqlbuilder.builder.QueryBuilderH2;
...
public class SelectTest {
    ...
    public void selectAllFromTable() throws Exception {
        List<Person> persons = new QueryBuilderH2(connection).select()
                .all()
                .from()
                .table("PERSON p")
    ...
    public void selectAllFromTableWhereConditions() throws Exception {
        ...
        persons = new QueryBuilderH2(connection).select()
                .all()
                .from()
                .table("PERSON p")
    ...
    public void selectAllFromTableSingleResult() throws Exception {
        Person person = new QueryBuilderH2(connection).select()
                .all()
                .from()
                .table("PERSON p")
                .where()
    ...
    public void selectAllFromTableSingleResult_throwExceptionIfMoreThanOneResultIsReturned() throws Exception {
        new QueryBuilderH2(connection).select()
                .all()
                .from()
                .table("PERSON p")
                .single(new PersonRowMapper());
    ...
    public void selectAllFromTableGroupBy() throws Exception {
        List<Integer> counts = new QueryBuilderH2(connection).select()
                .count("*")
                .from()
                .table("PERSON p")
                .groupBy()
        ...
        counts = new QueryBuilderH2(connection).select()
                .count("*")
                .from()
                .table("PERSON p")
                .groupBy("p.birthday")
    ...
    public void selectCountFromTableGroupByHaving() throws Exception {
        List<Integer> counts = new QueryBuilderH2(connection)
                .select()
                .count("c.country_name")
                .from()
    ...
    public void selectColumnsFromTableGroupByHavingOrderBy() throws Exception {
        List<Country> countries = new QueryBuilderH2(connection)
                .select()
                .column("c.country_name")
                .from()
                .tables("PERSON p", "COUNTRY c")
        ...
        countries = new QueryBuilderH2(connection)
                .select()
                .column("c.country_name")
                .from()
                .tables("PERSON p", "COUNTRY c")
    ...
    @Test
    public void selectAllFromTableWithPagination_H2() throws Exception {
        List<Person> persons = new QueryBuilderH2(connection).select()
                .all()
                .from()
                .table("PERSON p")
